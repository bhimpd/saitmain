...
<head>
    ...
    <title>S.A.I.T Solution And Trade Concern | Grandstream HT801</title>
            ...
            <div class="row g-0">
                <div class="col-md-6 border-end">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="main_image"> <img src="images/grand.webp" id="main_product_image" width="350"> </div>
                        <div class="thumbnail_images">
                            <ul id="thumbnail">
                                <li><img onclick="changeImage(this)" src="images/g1.webp" width="70px"></li>
                                <li><img onclick="changeImage(this)" src="images/grand.webp" width="70px"></li>
                                <li><img onclick="changeImage(this)" src="images/g2.webp" width="70px"></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            <div class="image" data-aos="zoom-in-up">
                                <img class="img-fluid" src="images/grand.webp" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12">
                            <div class="text">
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="text">
                                ...
                                <hr style="text-align: center;">
                                <p data-aos="fade-up">Supports 1 SIP profile through a single FXS port and a single 10/100Mbps port
                                    ...
                                    Supports advanced telephony features, including call transfer, call forward, call-waiting, do not disturb, message waiting indication, multilanguage prompts, flexible dial plan and more</p>
                            </div>
                        </div>

                        <div class="col-lg-6 col-sm-12">
                            <div class="image" data-aos="zoom-in-up">
                                <img class="img-fluid" src="images/g1.webp" alt="">
                            </div>
                        </div>

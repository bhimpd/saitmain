...
<head>
    ...
    <title>S.A.I.T Solution And Trade Concern | Mikrotik hAP Lite RB941-2nD </title>
            ...
            <div class="row g-0">
                <div class="col-md-6 border-end">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="main_image"> <img src="images/mik.jpg" id="main_product_image" width="350"> </div>
                ...
                <div class="col-md-6">
                    <div class="p-3 right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h1>Mikrotik hAP Lite RB941-2nD</h1>
                        </div>
                        <div class="mt-2 pr-3 content">
                            <h6>Mikrotik hAP lite Low cost home wireless AP with dual chain 2.4GHz wireless, powered by USB.</h6>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            <div class="image" data-aos="zoom-in-up">
                                <img class="img-fluid" src="images/hap.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12">
                            <div class="text">
                                <h1 data-aos="fade-up">hAP lite
                                </h1>
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="text">
                                <h1 data-aos="fade-up">Low cost home wireless AP with dual chain 2.4GHz wireless, powered by USB</h1>
                                <hr style="text-align: center;">
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="image" data-aos="zoom-in-up">
                                <img class="img-fluid" src="images/hap2.png" alt="">
                            </div>
                        </div>

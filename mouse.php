...
<head>
    ...
    <title>S.A.I.T Solution And Trade Concern | Wireless Mouse – PMW5008 </title>
            ...
            <div class="row g-0">
                <div class="col-md-6 border-end">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="main_image"> <img src="images/mouse.jpg" id="main_product_image" width="350"> </div>
                ...
                <div class="col-md-6">
                    <div class="p-3 right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h1>Wireless Mouse – PMW5008</h1>
                        </div>
                        <div class="mt-2 pr-3 content">
                            <h6>PROLiNK® PMW5008 is designed for comfort with both left-handed and right-handed users in mind. The mouse works smoothly on various surface, from marble countertops to laminated table tops, thanks to its high precision optical sensor.
                            </h6>
                        </div>
                        <div class="brotherinfo">
                            <ul>
                                ...
                                <li>
                                    <p class="p1"> Weight</p>
                                    <p>48g (product only)</p>
                                </li>
                                <li>
                                    <p class="p1">Dimension
                                    </p>
                                    <p>103 x 64 x 31mm (product only)

                                    </p>
                                </li>
                                <li>
                                    <p class="p1"> Compatible OS
                                    </p>
                                    <p>Windows 7/8/10, MacOS
                                    </p>
                                </li>
                                <li>
                                    <p class="p1">Interface
                                    </p>
                                    <p>USB</p>
                                </li>

                                <li>
                                    <p class="p1">Transmission Range</p>
                                    <p>Up to 10 meters, 360 degrees
                                    </p>
                                </li>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            <div class="image" data-aos="zoom-in-up">
                                <img class="img-fluid" src="images/ambid.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12">
                            <div class="text">
                                <h1 data-aos="fade-up">Ambidextrous design</h1>
                                <hr style="text-align: center;">
                                <p data-aos="fade-up">Fits snuggly with both left and right-handed grips.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="text">
                                <h1 data-aos="fade-up">High-precision optical sensor</h1>
                                <hr style="text-align: center;">
                                <p data-aos="fade-up">,600DPI high-precision optical sensor delivers a smooth and responsive cursor control on a variety of surfaces.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12">
                            <div class="image" data-aos="zoom-in-up">
                                <img class="img-fluid" src="images/highpre.png" alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="image" data-aos="zoom-in-up">
                                <img class="img-fluid" src="images/travel.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12">
                            <div class="text">
                                <h1 data-aos="fade-up">Travel-friendly</h1>
                                <hr style="text-align: center;">
                                <p data-aos="fade-up">Absolute storage convenience with built-in nano-receiver slot at the back of the mouse.</p>
                            </div>
                        </div>

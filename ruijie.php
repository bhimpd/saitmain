...
<head>
    ...
    <title>S.A.I.T Solution And Trade Concern |Ruijie RG RAP2200( F) Wi-Fi 5 1267Mbps Ceiling Access Point</title>
            ...
            <div class="row g-0">
                <div class="col-md-6 border-end">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="main_image"> <img src="images/ruji.png" id="main_product_image" width="350"> </div>
                        <div class="thumbnail_images">
                            <ul id="thumbnail">
                                <li><img onclick="changeImage(this)" src="images/ruijie2.png" width="70px"></li>
                                <li><img onclick="changeImage(this)" src="images/ruijie3.jpg" width="70px"></li>
                                <li><img onclick="changeImage(this)" src="images/ruijie4.jpg" width="70px"></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="p-3 right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h1>Ruijie RG RAP2200( F) Wi-Fi 5 1267Mbps Ceiling Access Point</h1>
                        </div>
                        ...
                        <div class="brotherinfo">
                            <ul>
                                ...
                                <li>
                                    <p class="p1">Weight</p>
                                    <p>0.45kg (excluding mounting kits)</p>
                                </li>
                                <li>
                                    <p class="p1">Dimension</p>
                                    <p>194mm × 194mm × 35mm</p>
                                </li>
                                <li>
                                    <p class="p1">Compatible OS</p>
                                    <p>Windows 7/8/10, MacOS</p>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <p>802.3af/at PoE, 12V/1.5A DC Adaptor</p>
                                </li>
                                <li>
                                    <p class="p1">Wireless Protocol</p>
                                    <p>802.11ac Wave2, 1267Mbps</p>
                                </li>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            <div class="image" data-aos="zoom-in-up">
                                <img class="img-fluid" src="images/ruji.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12">
                            <div class="text">
                                <h1 data-aos="fade-up">RG-RAP2200(F) Reyee Wi-Fi 5 1267Mbps Ceiling Access Point
                                    Hospitality, Enterprise, Education, Government, Retail, etc.
                                </h1>
                                <hr style="text-align: center;">
                                <p data-aos="fade-up">The home Access Point lite (hAP lite) is an ideal little device for your apartment, house or office.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="text">
                                <h1 data-aos="fade-up">Dual-radio performance, up to 1.267Gbps.
                                    ...
                                    With Ruijie Cloud, easy to maintain your networks remotely.</h1>
                                <hr style="text-align: center;">
                                <p data-aos="fade-up">It supports button triggered WPS, for the convenience of not typing a complicated password when somebody wants to have wireless internet access, and can also be told to change to cAP mode and join a CAPsMAN centrally managed network by the push of a button. Of course, the device runs RouterOS with all the features, bandwidth shaping, firewall, user access control and many others.The hAP lite is equipped with a powerful 650MHz CPU, 32MB RAM, dual chain 2.4GHz onboard wireless, four Fast Ethernet ports and a RouterOS L4 license. USB power supply is included.</p>
                            </div>
                        </div>

                        <div class="col-lg-6 col-sm-12">
                            <div class="image" data-aos="zoom-in-up">
                                <img class="img-fluid" src="images/ruijie3.jpg" alt="">
                            </div>
                        </div>

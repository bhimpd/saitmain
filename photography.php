...
<head>
    ...
    <title>S.A.I.T Solution And Trade Concern | Technologies Services | Photography</title>
...
<body>
    ...
    <!-- photography services started -->
    <div class="bgimage"  data-aos="zoom-in-up">
        <div class="photography">
            <h1  data-aos="fade-up">Photography</h1>
            <h5  data-aos="fade-up">There is no best way to freeze time and relive a moment other than capturing them in photographs. Be it a birthday party, wedding photoshoot, maternity photoshoot, a wildlife photography or any occasion that you want to remember forever, S.A I.T Solution and Trade Concern is here to be your relying partner for seizing each of your special life moments in pictures. We provide photoshoot services as per your request, in occasions you want, in the most economical price range. We also provide videography service as per customer’s requirements and develop cinematic videos that will help you recall, re-experience and go through all the emotions you felt at that special moment by simply pressing the video play button.</h5>
        </div>


    </div>
    <!-- photography services ended -->
